...
public class GamePadPractice extends OpMode {
    ...
    public void loop() {
        ...
        telemetry.addData("left x", gamepad1.left_stick_x); // FOR LEFT STICK LEFT AND RIGHT
        telemetry.addData("left y",speedForward); // FOR LEFT STICK UP AND DOWN -1 on top
        telemetry.addData("right x", gamepad1.right_stick_x);
        telemetry.addData("right y", gamepad1.right_stick_y);

        telemetry.addData("A button", gamepad1.a); // FOR BUTTON A
